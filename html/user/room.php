		<div class="col-lg-8">
				...
				<div class="pull-right" style="margin-right:10px; margin-top:7px;">
					<?php
						if ($chatrow['userid']==$_SESSION['id']){
							?>
							<a href="index.php" class="btn btn-primary"><span class="glyphicon glyphicon-arrow-left"></span> Retourner</a>
							<a href="#delete_room" data-toggle="modal" class="btn btn-danger">Supprimer le groupe</a>
							<a href="#add_member" data-toggle="modal" class="btn btn-primary">Ajouter un membre</a>
							<?php
						}
						else{
							?>
							<a href="index.php" class="btn btn-primary"><span class="glyphicon glyphicon-arrow-left"></span> Accueil</a>
							<a href="#leave_room" data-toggle="modal" class="btn btn-warning">Quitter le group</a>
							<?php
						}
					?>
				</div>
			...
			<div>
				<div class="panel panel-default" style="height: 400px;">
					...
					<span style="font-size:10px; margin-left:10px;"><i>Note: Évitez d’utiliser un langage grossier et des propos haineux pour ne pas interdire les comptes</i></span>
					<div style="height:10px;"></div>
				...
				<div class="input-group">
					<input type="text" class="form-control" placeholder="Tapez le message ..." id="chat_msg">
